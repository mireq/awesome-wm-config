...
local function launch_terminal(cmd)
	...
	local font = 'xft:DejaVu Sans Mono for Powerline:style=normal:pixelsize={urxvt_font_size},xft:Noto Color Emoji:stye=normal:pixelsize={urxvt_font_size}::slant=0:weight=100:minspace=True,xft:DejaVuSansMono Nerd Font:style=normal:pixelsize={urxvt_font_size}:slant=0:weight=100:minspace=True'
